...
from src.model_stuff.downstream_model_cnn_regressor import MyDownstreamModel
...
EXP_NAME = f"CNN_regressor_{ON_SERVER}_fe{fe}_gs{gs}_bs{bs}_lr{lr}_drpout{drpout}_freeze{freeze}_nFC{nFC}"
